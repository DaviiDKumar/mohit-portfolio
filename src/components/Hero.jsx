...
export default function Hero() {
    return (
        <section className="w-full lg:w-[80vw] mx-auto min-h-screen flex flex-col md:flex-row items-center justify-center Apx-6 py-24 relative overflow-hidden">
            ...
            <div className="md:w-1/2 flex flex-col justify-center items-center md:items-start text-left mb-10 md:mb-0 px-12 md:px-4">
                <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                    Hi, I'm <span className="text-blue-600">Mohit Yadav</span>
                </h1>
